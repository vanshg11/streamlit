...
# Load data files for additional information
...
# Updated function to avoid feature names warning
...
# Helper function to retrieve disease-related information
def helper(disease):
    ...
    die = die if len(die) > 0 else ["No diet plan available."]
    
    wrkout = workout[workout['disease'] == disease]['workout'].values
    wrkout = wrkout if len(wrkout) > 0 else ["No workout recommendation available."]
    
    return desc, pre, med, die, wrkout

# Streamlit UI
st.title("Disease Prediction and Health Advice")
st.write("Enter your symptoms to predict a possible disease and get health recommendations.")

# User Input for Symptoms
user_symptoms = st.text_input("Enter symptoms separated by spaces (e.g., itching skin_rash nodal_skin_eruptions)")
